    ...
    config = (0, config_plugins_1.withDangerousMod)(config, [
        ...
        async (newConfig) => {
            ...
            fs_1.default.readFile(`${root}/Podfile`, "utf-8", (err, data) => {
                data = (0, insertLinesHelper_1.insertLinesHelper)(`  pod 'ViroReact', :path => '../node_modules/@equationalapplications/react-viro/ios'\n` +
                    `  pod 'ViroKit', :path => '../node_modules/@equationalapplications/react-viro/ios/dist/ViroRenderer/'`, "post_install do |installer|", data, -1);
